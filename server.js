...
// Redirect /pages/reminders.html to the correct /pages/remainders.html
app.get('/pages/reminders.html', (req, res) => {
  res.redirect('/pages/remainders.html');
});
...
app.post('/auth/email', (req, res) => {
  ...
  // Update login time / count in JSON
...
// ── PROXY: /api/cosine-alternatives → Flask :5000 ──
...
// After your existing route registrations (around where you have other app.use):
